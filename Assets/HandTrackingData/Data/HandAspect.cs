...
namespace HandTrackingData.Data
{
    public class HandAspect
    {
        ...
        private HandPostionsForCalc originalPositionData;
        public HandAspect(HandPostionsForCalc data)
        {
        ...
        public void SetAllAspects(HandPostionsForCalc data)
        {
        ...
        #endregion
        public int CompareTo(HandAspect other)
        {
            int diffs = 0;
            for (int i = 0; i < 5; i++)
            {
        ...
        public static void DrawDebugLines(HandPostionsForCalc data)
        {
        ...
        public HandPostionsForCalc GetData()
        {
        ...
        public static double[] ConvertHandInputs(HandPostionsForCalc data)
        {
            double[] handInputs = new double[18];
